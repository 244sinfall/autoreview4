const ClaimedItemsHTMLParts = {
    headLine: `<p style="text-align: center;" rel="text-align: center;"><span style="font-size: 14px;"><strong>Таблица именных предметов</strong>
</span>
</p>
<hr>`,
    header: `<table>
...
export default ClaimedItemsHTMLParts